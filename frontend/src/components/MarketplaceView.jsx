        ...
        <section className="result-card shadow-sm mb-4 marketplace-hero-card">
          <div className="row g-4 align-items-center">
            <div className="col-lg-7">
              ...
              <h1 className="section-title mb-3">Materiales remanentes listos para comprar</h1>
              <p className="section-text mb-0">
                Un espacio separado del generador para que arquitectos publiquen excedentes y usuarios encuentren
                oportunidades reales con filtros, búsqueda y publicaciones visuales.
              </p>
            </div>
        ...
        <section className="result-card shadow-sm mb-4">
          <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <div>
              ...
              <h2 className="h4 fw-bold mb-0">Buscá por material, zona, precio o palabra clave</h2>
            </div>
          </div>
